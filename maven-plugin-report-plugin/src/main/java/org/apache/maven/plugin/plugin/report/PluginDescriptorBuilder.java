...
public class PluginDescriptorBuilder {
     ...
     */
    @Deprecated
    public ExtendedPluginDescriptor build(Reader reader) throws PlexusConfigurationException {
     ...
     */
    @Deprecated
    public ExtendedPluginDescriptor build(Reader reader, String source) throws PlexusConfigurationException {
        return build(() -> reader, source);
    }

    public ExtendedPluginDescriptor build(ReaderSupplier readerSupplier) throws PlexusConfigurationException {
        return build(readerSupplier, null);
    }

    public ExtendedPluginDescriptor build(ReaderSupplier readerSupplier, String source)
     ...
     */
    @Deprecated
    public ExtendedPluginDescriptor build(InputStream input, String source) throws PlexusConfigurationException {
        return build(() -> input, source);
    }

    public ExtendedPluginDescriptor build(StreamSupplier inputSupplier) throws PlexusConfigurationException {
        return build(inputSupplier, null);
    }

    public ExtendedPluginDescriptor build(StreamSupplier inputSupplier, String source)
            throws PlexusConfigurationException {
    ...
    private ExtendedPluginDescriptor build(String source, String nsUri, XMLStreamReader xsr)
        ...
        if (PLUGIN_2_0_0.equals(nsUri)) {
            ...
            return new ExtendedPluginDescriptor(new PluginDescriptor(pd));
        } else {
            PlexusConfiguration cfg = buildConfiguration(xsr);
            return build(source, cfg);
        }
    }

    protected PlexusConfiguration buildConfiguration(XMLStreamReader xsr) throws XMLStreamException {
    ...
    private ExtendedPluginDescriptor build(String source, PlexusConfiguration c) throws PlexusConfigurationException {
        ExtendedPluginDescriptor pluginDescriptor = new ExtendedPluginDescriptor(new PluginDescriptor());
    ...
    private List<MojoDescriptor> extractMojos(PlexusConfiguration c, ExtendedPluginDescriptor pluginDescriptor)
            throws PlexusConfigurationException {
    ...
    public MojoDescriptor buildComponentDescriptor(PlexusConfiguration c, ExtendedPluginDescriptor pluginDescriptor)
            throws PlexusConfigurationException {
        ...
        for (PlexusConfiguration d : parameterConfigurations) {
            EnhancedParameterWrapper parameter = new EnhancedParameterWrapper(new Parameter());
            ...
            if (configTypeJavadocUrl != null) {
                ...
                parameter.setTypeJavadocUrl(URI.create(parameterTypeJavadocUrl));
            }
